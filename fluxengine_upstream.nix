# taken from https://github.com/NixOS/nixpkgs/blob/c3cf66ac632595de38adc7f88d3ff87f8e3230db/pkgs/by-name/fl/fluxengine/package.nix
# https://github.com/NixOS/nixpkgs/pull/425174
{
  lib,
  stdenv,
  fetchFromGitHub,
